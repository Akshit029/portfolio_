...
export const ABOUT_TEXT = `I am a dedicated and versatile full stack development student with a passion for creating efficient and user-friendly web applications. Over the past few years, I have gained experience working with technologies like React, Next.js, Node.js, and MongoDB. My journey in web development began with a deep curiosity about how things work, and it has evolved into a path where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I stay active, explore new technologies, and contribute to open-source projects.`;
